...
padre.removeChild(el);
        ...
        <div id="contenido" >
           <?php
               ...
               {
                 $id_mas=  ($_POST['id']);
               $Resultado=mysql_query("SELECT * FROM post where id>$id_mas and tipo='Aplicaciones' ORDER BY  id desc limit 28");    
               }else{
                    $Resultado=mysql_query("SELECT * FROM post where tipo='Aplicaciones' ORDER BY fecha desc LIMIT 28");
                }
