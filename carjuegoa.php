...
<link rel="stylesheet" type="text/css" href="css/style_vent_post.css" media="screen" />
              ...
              <?php
               ...
               {
                 $id_mas=  ($_POST['id']);
               $Resultado=mysql_query("SELECT * FROM post where id<$id_mas and tipo='Juegos' ORDER BY  fecha desc limit 28");    
               }
...
<a  target="_blank" class="submit" href="'.$apli["url_archivo"].'">
<div id="bgt"><div class="btn_desc">Descargar</div></div></a> 
</div>    
